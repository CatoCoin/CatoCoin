...
In order to support loading of multiple wallets in catocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is catocoin.cpp.
...
Changes to catocoin.cpp
----------------------
catocoin.cpp is the entry point into catocoin-qt, and as such, will require some minor modifications to provide hooks for

...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Catocoin Core"),
     ...
     * override -datadir in the catocoin.conf file in the default data directory
     * (to be consistent with catocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

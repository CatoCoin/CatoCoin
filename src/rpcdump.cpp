...
Value importprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"catocoinprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"catocoinprivkey\"   (string, required) The private key (see dumpprivkey)\n"
...
Value dumpprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"catocoinaddress\"   (string, required) The catocoin address for the private key\n"
            "\nResult:\n"
...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"catocoinaddress\"\n"
            "\nEncrypts a private key corresponding to 'catocoinaddress'.\n"
            "\nArguments:\n"
            "1. \"catocoinaddress\"   (string, required) The catocoin address for the private key (you must hold the key already)\n"

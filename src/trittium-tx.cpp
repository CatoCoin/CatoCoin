...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Catocoin Core catocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  catocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded catocoin transaction") + "\n" +
                               "  catocoin-tx [options] -create [commands]   " + _("Create hex-encoded catocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded catocoin transaction

Contributing to Catocoin Core
============================

The Catocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Catocoin Core project, and is not to be
confused with overall Catocoin Network Protocol consensus changes.

Whether a pull request is merged into Catocoin Core rests with the project merge
...
Patches that change Catocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Catocoin consensus, it must have been
...
The project leader is the release manager for each Catocoin Core release.
